...
public class CliHelpPrinter {
    ...
    public void printHelp(final PrintStream err) {
        ...
        err.println("Verwendung: process|watch|serve|ui [--input <path>] [--config <path>]"
                + " [--profile <default|test|production>] [--skip-ocr] [--mock-text]");
        err.println("Befehle:");
        ...
        err.println("  ui       startet die browserbasierte Exportoberflaeche");
        ...
        err.println("  ui --config config/application.properties --profile production");
